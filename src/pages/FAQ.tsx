...
const faqItems = [
  ...
  { value: "item-int", question: "Do you ship internationally (and to Canada)?", answer: "Yes! We ship to 100+ countries worldwide, including the US, Canada 🇨🇦, UK, Ireland, Australia, New Zealand, Germany, France, the Netherlands, Spain, Italy, and Japan. International delivery typically takes 7-14 business days and customs fees may apply depending on your country. Don't see your country listed? Ask our support hedgehogs in the chat widget for the full list and a shipping quote." },
  { value: "item-addr", question: "How do I change my shipping address?", answer: "Before your order ships (while it still shows Processing), update the address in your customer portal under Orders → Edit shipping, or reply to your confirmation email — the change applies automatically. If your order has already shipped, message our support team with your order number and we'll reroute the delivery or arrange a reshipment. For subscriptions, updating your saved address applies to all future shipments." },
